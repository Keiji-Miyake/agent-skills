---
name: dev-ready
description: 開発開始前の準備チェック。作業履歴・タスク・ToDoを確認し、実行すべき作業を提案する。開発セッション開始時に使用。
license: MIT License
metadata:
  author: Keiji Miyake
  version: "1.0"
...
開発セッション開始時にプロジェクトの現状を把握し、次のアクションを提案するスキルです。
